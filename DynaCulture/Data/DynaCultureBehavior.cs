...
namespace DynaCulture.Data
{
    class DynaCultureBehavior : CampaignBehaviorBase
    {
        ...
        public void DailyTickSettlementMod(Settlement settlement)
        {
            ...
            if (!DynaCultureSettings.Instance.PlayerKingdomOnly || (DynaCultureSettings.Instance.PlayerKingdomOnly && settlement.Owner != null  && settlement.Owner.IsHumanPlayerCharacter))
            {
